...
func (c *chatServiceClient) GetBindingsByChat(ctx context.Context, in *GetBindingsByChatRequest, opts ...grpc.CallOption) (*GetBindingsByChatResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatService_GetBindingsByChat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) GetUserWithChatByThreadID(ctx context.Context, in *GetUserWithChatByThreadIDRequest, opts ...grpc.CallOption) (*GetUserWithChatByThreadIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatService_GetUserWithChatByThreadID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) GetUsersByChatID(ctx context.Context, in *GetUsersByChatIDRequest, opts ...grpc.CallOption) (*GetUsersByChatIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatService_GetUsersByChatID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) GetThreadContext(ctx context.Context, in *GetThreadContextRequest, opts ...grpc.CallOption) (*GetThreadContextResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatService_GetThreadContext_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
