...
const file_proto_userpb_user_proto_rawDesc = "" +
	"\n" +
	"\x17proto/userpb/user.proto\x12\x04user\"N\n" +
	...
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12#\n" +
	"\rpassword_hash\x18\x03 \x01(\tR\fpasswordHash2\xdf\x01\n" +
	"\vUserService\x12?\n" +
	"\n" +
	...
	"\vGetUserByID\x12\x18.user.GetUserByIDRequest\x1a\x19.user.GetUserByIDResponseB=Z;github.com/Vovarama1992/go-ai-messenger/proto/userpb;userpbb\x06proto3"
