...
// Source: internal/user/ports/user_repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/user/ports/user_repository.go -destination=internal/user/mocks/mock_user_repository.go -package=mocks
//
