...
// Source: ws-ai-advice//internal/ports/socket_conn.go
//
// Generated by this command:
//
//	mockgen -source=ws-ai-advice//internal/ports/socket_conn.go -destination=ws-ai-advice//internal/mocks/socket_conn_mock.go -package=mocks
//
...
func (m *MockConn) GetToken() string {
	m.ctrl.T.Helper()
...
func (mr *MockConnMockRecorder) GetToken() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetToken", reflect.TypeOf((*MockConn)(nil).GetToken))
}
