...
func (m *MockChatService) GetUsersByChatID(ctx context.Context, chatID int64) ([]int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUsersByChatID", ctx, chatID)
	ret0, _ := ret[0].([]int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockChatServiceMockRecorder) GetUsersByChatID(ctx, chatID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUsersByChatID", reflect.TypeOf((*MockChatService)(nil).GetUsersByChatID), ctx, chatID)
}
