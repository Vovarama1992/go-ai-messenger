...
//
//	mockgen -source=internal/chat/ports/chat_repository.go -destination=internal/chat/mocks/mock_chat_repository.go -package=mocks
//
...
func (m *MockChatRepository) FindBindingsByChatID(ctx context.Context, chatID int64) ([]*model.ChatBinding, error) {
	m.ctrl.T.Helper()
...
func (mr *MockChatRepositoryMockRecorder) FindBindingsByChatID(ctx, chatID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindBindingsByChatID", reflect.TypeOf((*MockChatRepository)(nil).FindBindingsByChatID), ctx, chatID)
}
