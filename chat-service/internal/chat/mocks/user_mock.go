...
// Source: chat-service//internal/chat/ports/user.go
//
// Generated by this command:
//
//	mockgen -source=chat-service//internal/chat/ports/user.go -destination=chat-service//internal/chat/mocks/user_mock.go -package=mocks
//
